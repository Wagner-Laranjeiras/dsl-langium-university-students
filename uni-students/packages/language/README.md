...
- [src/university-students.langium](src/university-students.langium) -  The grammar definition of your language
- [src/university-students-module.ts](src/university-students-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/university-students-validator.ts](src/university-students-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/university-students.monarch.ts](src/syntaxes/university-students.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/university-students.tmLanguage.json](syntaxes/university-students.tmLanguage.json) - Textmate based syntax highlighting instructions.
